/**
 * Generates two placeholder JPGs for blog post 4 (league of legends youth dev).
 * Mirrors scripts/gen-blog-post-3-placeholders.js. Solid background, sentence-case
 * label centered. Under 100KB each.
 *
 * Run from repo root:
 *   node scripts/gen-blog-post-4-placeholders.js
 */
...
(async () => {
  ...
  await makeImage("blog-post-4-card.jpg", 1232, 770, "Blog post 4 — card placeholder.");
  await makeImage("blog-post-4-hero.jpg", 1232, 520, "Blog post 4 — hero placeholder.");
})();
