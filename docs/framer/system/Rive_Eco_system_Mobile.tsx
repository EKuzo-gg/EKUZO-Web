// Path: Rive_Animation/Eco_system_Mobile.tsx
// Code file ID: dDNDl2J
// Used on: Home page (mobile ecosystem section)
...
// triggerOnce: true (mobile doesn't reset on re-entry)
...
export default function EcoMobile() {
    ...
    const scrollPctInput = rive.useStateMachineInput(
        riveInstance,
        STATE_MACHINE_NAME,
        INPUT_NAME,
        0
    ...
    useEffect(() => {
        if (scrollPctInput) scrollPctInput.value = scrollPct
    }, [scrollPct, scrollPctInput])
    ...
    useEffect(() => {
        ...
        const onTouchStart = (e: TouchEvent) => {
            ...
            const { x, y } = toCanvasXY(e.touches[0])
